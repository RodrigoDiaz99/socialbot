    ...
    <div class="py-6">
        <div class="flex max-w-md bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="w-2/3 p-4">
                ...
                <p class="mt-2 text-gray-600 text-sm">Para poder usar las funciones del bot para twitter es necesario
                    acceder.</p>

                <div class="flex item-center justify-between mt-3">
                    <a href="{{ route('login.twitter') }}"
                        class="px-3 py-2 bg-gray-800 text-white text-xs font-bold uppercase rounded">Acceder a twitter</a>
                    <a href="{{ route('twitter.post') }}"
                        class="px-3 py-2 bg-gray-800 text-white text-xs font-bold uppercase rounded">{{ $twitter ? 'Post a Messages' : 'pending' }}</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="flex">
                ...
                <div class="flex-1 px-2 pt-2 mt-2">
                    <textarea class=" bg-transparent text-gray-400 font-medium text-lg w-full" rows="2" cols="50"
                        placeholder="What's happening?" name="message" id="message"></textarea>
                    <div id="preview"></div>
                </div>
            </div>
